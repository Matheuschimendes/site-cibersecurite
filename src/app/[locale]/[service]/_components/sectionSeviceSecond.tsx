...
import { CardsService } from "@/app/[locale]/[service]/_components/cardsSecvice";
...
const CardWithLight = ({ feature }: { feature: Feature }) => {
  ...
  return (
    <div
      ...
      className="
        relative group flex flex-col gap-4 sm:gap-6 p-6 sm:p-10
